import { MeshBasicMaterialProps, MeshProps, SphereGeometryProps } from "@react-three/fiber";
...
const Sphere = React.forwardRef((props: SphereProps, ref: React.ForwardedRef<Mesh>) => {
